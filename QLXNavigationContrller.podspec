...
s.homepage = 'https://github.com/QiuLiangXiong/QLXNavigationContrller'
s.authors = { 'QiuLiangXiong' => '820686089@qq.com' }
s.source = { :git => 'https://github.com/QiuLiangXiong/QLXNavigationContrller.git', :tag => "1.0.0" }
s.requires_arc = true
